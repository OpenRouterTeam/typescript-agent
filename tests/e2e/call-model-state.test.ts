    ...
    it('should persist state across tool execution', async () => {
      ...
      const result = await client.callModel({
        ...
        input: [
          {
            role: 'user',
            content: 'Say hello using the echo tool with message "test"',
          },
        ],
        tools: [
          echoTool,
    ...
    it('should identify tools requiring approval', async () => {
      ...
      const result = await client.callModel({
        ...
        input: [
          {
            role: 'user',
            content: 'Delete the file at /tmp/test.txt',
          },
        ],
        tools: [
          dangerousTool,
    ...
    it('should use custom requireApproval function', async () => {
      ...
      const result = await client.callModel({
        ...
        input: [
          {
            role: 'user',
            content: 'Perform safe_action with action "test"',
          },
        ],
        tools: [
          safeTool,
